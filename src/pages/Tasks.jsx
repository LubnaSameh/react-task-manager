...
const Tasks = () => {
  ...
  return (
    <div className="relative  flex items-center justify-center py-8 min-h-screen bg-gradient-to-r from-blue-500 via-indigo-600 to-purple-700 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-white">
